...
const filters = [
  ...
  },
  {
    ...
    name: "Type",
    options: [
      { value: "T-shirt", label: "Tshirt", checked: false },
  ...
  },
  {
    ...
    name: "Seelves",
    options: [
      { value: "Half Seelves", label: "White", checked: false },
      { value: "Full Seelves", label: "Beige", checked: false },
      { value: "blue", label: "Blue", checked: true },
      { value: "brown", label: "Brown", checked: false },
      { value: "green", label: "Green", checked: false },
      { value: "purple", label: "Purple", checked: false },
